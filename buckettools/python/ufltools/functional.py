...
class Functional:
  ...
  def write_ufl(self):
    ...
    if self.function.type=="Constant":
      ufl.append(declaration_comment("Constant", self.function.name))
      ufl.append(constant_ufl(self.function.symbol, self.function.system.cell))
    else:
      ufl.append(declaration_comment("Element", self.function.name))
      ufl += self.function.element_ufl()
      ufl.append("\n")
      ufl.append(declaration_comment("Coefficient", self.function.name))
      ufl.append(coefficient_ufl(self.function.symbol))
    ufl.append("\n")
    ufl.append(declaration_comment("Form", self.name))
