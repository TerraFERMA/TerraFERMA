...
namespace buckettools
{
  ...
  FunctionSpace_ptr ufc_fetch_coefficientspace(const std::string &systemname, const std::string &solvername, const std::string &coefficientname, Mesh_ptr mesh);

  // A function to return a functionspace (for a coefficient) from a system given a mesh, a solvername and a functionname.
  FunctionSpace_ptr ufc_fetch_coefficientspace(const std::string &systemname, const std::string &functionname, const std::string &funcionalname, const std::string &coefficientname, Mesh_ptr mesh);
