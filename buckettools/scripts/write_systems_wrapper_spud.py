...
functionspace_cpp         = []
functionspace_cpp.append("  FunctionSpace_ptr fetch_functionspace(std::string systemname, std::string functionname, Mesh_ptr mesh)\n")
...
for i in range(libspud.option_count("/system")):
  ...
  functional_cpp.append("      case \""+system.name+"\":\n")
  functional_cpp.append("        switch(functionname)\n")
  functional_cpp.append("        {\n")
  ...
  for j in range(libspud.option_count(system_optionpath+"/field")):
    ...
    functional_cpp.append("          case \""+field.name+"\":\n")
    functional_cpp.append("            switch(functionalname)\n")
    functional_cpp.append("            {\n")
    ...
    for k in range(libspud.option_count(field_optionpath+"/type/output/include_in_diagnostics/functional")):
      ...
      include_cpp.append("#include \""+system.name+field.name+functional.name+".h\"\n")
      
      functional_cpp.append("              case \""+functional.name+"\":\n")
      functional_cpp.append("                Form_ptr functional(new "+system.name+field.name+functional.name+"::Form_0(*functionspace));\n")
      functional_cpp.append("                break;\n")
      
      # done with this functional
      del functional

    functional_cpp.append("              default:\n")
    functional_cpp.append("                dolfin::error(\"Unknown functionalname in fetch_functional\")\n")
    functional_cpp.append("            }\n")
    functional_cpp.append("            break;\n")
  ...
  for j in range(libspud.option_count(system_optionpath+"/coefficient")):
    ...
    functional_cpp.append("          case \""+coeff.name+"\":\n")
    functional_cpp.append("            switch(functionalname)\n")
    functional_cpp.append("            {\n")
    ...
    for k in range(libspud.option_count(coeff_optionpath+"/type/output/include_in_diagnostics/functional")):
      ...
      include_cpp.append("#include \""+system.name+coeff.name+functional.name+".h\"\n")
      
      functional_cpp.append("              case \""+functional.name+"\":\n")
      functional_cpp.append("                Form_ptr functional(new "+system.name+coeff.name+functional.name+"::Form_0(*functionspace));\n")
      functional_cpp.append("                break;\n")
  ...
  functional_cpp.append("          default:\n")
  functional_cpp.append("            dolfin::error(\"Unknown functionname in fetch_functional\")\n")
  functional_cpp.append("        }\n")
  functional_cpp.append("        break;\n")
